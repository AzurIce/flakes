...
rustPlatform.buildRustPackage rec {
  pname = "alvr";
  version = "21.0.0-dev01+nightly.2024.12.12";

  src = fetchFromGitHub {
    owner = "alvr-org";
    repo = "ALVR";
    rev = "3a060d3c6ec3e246b9933187bf4bf929dfc0ea4";
    fetchSubmodules = true; #TODO devendor openvr
    hash = "sha256-Ku28S3hSrMi/v4xXLBYAimVCdHKcdUW4vawlsbv7NNI=";
  };
  ...
  meta = with lib; {
    ...
    changelog = "https://github.com/alvr-org/ALVR/";
